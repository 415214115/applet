<template>
	<view class="guarantee">
		...
		<view class="guaranteeContent">
			...
			<view class="cont">
				<view class="contText">
					KWK色彩车身保护膜在产品施工后，根据产品所属的分类，在对应的统一质保时间内提供以下质量保证：
				</view>
				<view class="contText">
			...
			<view class="cont">
				<view class="contText">
					1、因天灾、外力或强酸碱物体等因素导致的车体、膜面损伤及不正确的保养方式造成的产品损伤，KWK色彩车身保护膜及施工单位将不承担任何责任。
				</view>
				<view class="contText">
					2、去除膜时，应由施工单位进行专业去除，由车主擅自去除操作引起的膜体损坏或漆面损伤，KWK色彩车身保护膜及施工单位将不承担任何责任。
				</view>
				<view class="contText">
					3、对认为造成的划痕或破损可由施工单位对破损部位进行局部修复或更换，将酌情收取工本费。
				</view>
			</view>
		</view>
	</view>
